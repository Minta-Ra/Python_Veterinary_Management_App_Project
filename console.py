...
# # Pets
# pet_1 = Pet("Layla", "09-09-2020", "Dog", "Ear drops needed to treat ear infection", owner_1, vet_3)
# pet_repository.save(pet_1)

# pet_2 = Pet("Mylo", "26-04-2016", "Cat", "Weekly spray from fleas", owner_2, vet_1)
# pet_repository.save(pet_2)

# pet_3 = Pet("Snoopy", "02-12-2018", "Rabbit", "Operation on teeth", owner_3, vet_2)
# pet_repository.save(pet_3)

# pet_4 = Pet("Bella", "24-10-2014", "dog", "Eye drops to treat red eye", owner_4, vet_4)
